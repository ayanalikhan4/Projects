...
tomato_img = PhotoImage(file="/Users/ayanalikhan/Desktop/CS/Development/Projects/Pomodoro/tomato.png")
...
start_button = Button(text = "Start",command=button_on_click,highlightthickness= 0)
